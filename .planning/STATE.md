...
|----------|-------|--------|
| Vite + React over Next.js | Setup | Pending |
| reactbits copy-paste model | Setup | Pending |
| Dark/light section alternation | Design | Pending |
| Vertical MVP phase structure | Planning | Confirmed |
